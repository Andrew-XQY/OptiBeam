...
def image_generator_wrapper(func, limit: int) -> Generator[np.ndarray, None, None]:
    """
    Generates a fixed number of images by calling the provided image generation function.

    Args:
        func: A function that returns an np.ndarray representing an image.
        limit (int): The number of images to generate.

    Yields:
        np.ndarray: The next image generated by func.
    """
