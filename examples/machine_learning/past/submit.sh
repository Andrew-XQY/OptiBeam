...
#SBATCH --output=results/slurm/nn_training-%j_%x_%Y%m%d.out   # Output file with job ID and date
#SBATCH --error=results/slurm/nn_training-%j_%x_%Y%m%d.err    # Error file with job ID and date
